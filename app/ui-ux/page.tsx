  ...
  return (
    <>
      <style>{`
        ...
        .ux-eco-num { font-family:var(--font-cormorant),serif; font-size:7rem; font-weight:300; color:rgba(255,255,255,.04); position:absolute; top:1rem; right:2rem; pointer-events:none; transition:color .5s; }
        .ux-eco-card:hover .ux-eco-num { color:rgba(255,255,255,.07); }
      ...
      <main style={{ backgroundColor:'#000000', color:'#ffffff', fontFamily:'var(--font-montserrat)', cursor:'none' }}>
        ...
        <FadeIn>
          <div className="ux-img-banner" style={{ height:'clamp(400px,58vh,700px)' }}>
            <img src="https://images.unsplash.com/photo-1561070791-2526d30994b5?w=1800&q=80&fit=crop&crop=center" alt="Modern UI design workspace" loading="lazy"/>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:2, background:'rgba(255,255,255,.1)' }}>
          <FadeIn>
            <div className="ux-img-banner" style={{ height:'clamp(300px,44vh,560px)' }}>
              <img src="https://images.unsplash.com/photo-1551650975-87deedd944c3?w=1200&q=80&fit=crop" alt="User research and testing" loading="lazy"/>
              <span className="ux-img-caption">User Research</span>
            </div>
          </FadeIn>
          <FadeIn delay={120}>
            <div className="ux-img-banner" style={{ height:'clamp(300px,44vh,560px)' }}>
              <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80&fit=crop" alt="Interface design process" loading="lazy"/>
        ...
        <FadeIn>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:2, background:'rgba(255,255,255,.08)', minHeight:500 }}>
            <div style={{ position:'relative', overflow:'hidden' }}>
              <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&q=80&fit=crop" alt="Design process and collaboration" loading="lazy" style={{ width:'100%', height:'100%', objectFit:'cover', filter:'brightness(.4) saturate(.6)', display:'block' }}/>
            </div>
        ...
        <FadeIn>
          <div className="ux-img-banner" style={{ height:'clamp(300px,42vh,540px)' }}>
            <img src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1800&q=80&fit=crop" alt="Modern digital interface design" loading="lazy"/>
        ...
        <section style={{ padding:'16vh 8vw', position:'relative', overflow:'hidden', background:'#050505' }}>
          <div style={{ position:'absolute', inset:0, background:'radial-gradient(ellipse 100% 80% at 50% 50%, rgba(30,30,30,.4) 0%, transparent 70%)', animation:'ux-breathe 8s ease-in-out infinite', pointerEvents:'none' }}/>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'2fr 1fr 1fr', gap:2, background:'rgba(255,255,255,.08)' }}>
          {[
            { src:'https://images.unsplash.com/photo-1551650975-87deedd944c3?w=1200&q=80&fit=crop', cap:'Wireframing' },
            { src:'https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?w=800&q=80&fit=crop', cap:'Prototyping' },
            { src:'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=800&q=80&fit=crop', cap:'Visual Design' },
          ].map((img, i) => (
            <FadeIn key={i} delay={i * 100}>
        ...
        <FadeIn>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:2, background:'rgba(255,255,255,.08)', minHeight:500 }}>
            ...
            <div style={{ position:'relative', overflow:'hidden' }}>
              <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80&fit=crop" alt="Premium digital interface" loading="lazy" style={{ width:'100%', height:'100%', objectFit:'cover', filter:'brightness(.4) saturate(.6)', display:'block' }}/>
            </div>
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <div className="ux-img-banner" style={{ height:'clamp(200px,28vh,360px)' }}>
            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1800&q=80&fit=crop" alt="UI/UX design consultation" loading="lazy"/>
