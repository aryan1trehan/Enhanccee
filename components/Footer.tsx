...
export default function Footer() {
  ...
  const serviceLinks = [
    ...
    { name: 'Growth Engineering', href: '#growth-engineering' },
    { name: 'Market Intelligence', href: '#market-intelligence' },
    { name: 'Executive Positioning', href: '#executive-positioning' },
  ]
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">Enhanccee</h3>
            <p className="text-white/70 text-sm leading-relaxed">
              Strategic marketing and growth for visionary companies
            </p>
            {/* Social Media Icons */}
            ...
            <ul className="space-y-3">
              {companyLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className={`text-white/70 text-sm transition-all duration-300 hover:text-gold ${
                      hoveredLink === link.name ? 'text-gold' : ''
                    }`}
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-white/70 text-sm transition-colors duration-300 hover:text-gold"
                >
                  hello@enhanccee.com
                </a>
              </li>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              href="#privacy"
              className="text-white/60 text-sm transition-colors duration-300 hover:text-gold"
            >
              Privacy Policy
            </a>
            <a
